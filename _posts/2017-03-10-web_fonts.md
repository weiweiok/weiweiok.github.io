...
### Web 安全字体
 ...
 通过对比 [Windows 默认字体列表][1] 和 [OS X 默认字体列表][2]，以及这些字体 [在各系统中版本占有率][3]，基本接近绝对安全的，有以下英文字体：

| 字体名称 | 特点 | 示例 |
| - | - | - |
| Arial | 无衬线，大写i与小写L难以区分 | Weiwei-iIlLoO0123 |
| Tahoma | 无衬线，可代替Arial | |
| Verdana | 无衬线，间距稍大 | |
| Trebuchet MS | 无衬线，偏粗 | |
| Georgia | 衬线，风格浑厚，数字尺寸不一 | |
| Times New Roman | 衬线，风格平滑，数字尺寸一致 | |
| Courier New | 等宽体，适合代码 | |
